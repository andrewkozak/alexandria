...
?>
  <li style="float:left;">
    <a class="fancybox-buttons" href="<?php print $i->getItemSrc(); ?>" rel="alexandria" title="">
      <img src="third-party/timthumb/timthumb.php?src=<?php print $i->getItemThumbSrc(); ?>&h=<?php print IMAGE_SIZE; ?>&w=<?php print IMAGE_SIZE; ?>&zc=1&q=100" class="alx_img_thumbs" style="height:<?php print IMAGE_SIZE; ?>px;width:<?php print IMAGE_SIZE; ?>px;" />
    </a>
